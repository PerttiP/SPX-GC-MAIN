...
In summary: assigning an object to the global window object only makes it accessible to scripts running on that same page—not across multiple pages within the same web app session.
*/
